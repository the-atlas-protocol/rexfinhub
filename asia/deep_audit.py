...
GRACE_XL = r"C:\Foundry\Rexfinhub\asia\grace_data\Asset report summary Feb 2026.xlsx"
REPORT_DATA = r"C:\Foundry\Rexfinhub\asia\report_data.json"
...
# From report HTML
import re
with open(r"C:\Foundry\Rexfinhub\asia\report_v15.html", 'r', encoding='utf-8') as fh:
    html = fh.read()
