...
with open('C:/Projects/rex-asia/report_v15.html', 'r', encoding='utf-8') as f:
    html = f.read()
...
with open('C:/Projects/rex-asia/report_data.json') as f:
    rdata = json.load(f)
...
df_xl = pd.read_excel('C:/Projects/rex-asia/reports/REX_Asia_Source_of_Truth_Feb26.xlsx',
